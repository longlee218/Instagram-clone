...
{{--                        <div class="dropdown">--}}
{{--                            <img class="ml-5 dropdown-toggle" id="dropdownMenuButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="{{ asset('svg/settings.svg') }}" alt="settings" width="5%" />--}}
{{--                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">--}}
{{--                                <a class="dropdown-item" href="#">Them bai</a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="details mt-3" style="display:flex; flex-direction:row; justify-content:start;">--}}
{{--                        <span class="mr-5"><strong>2</strong> bài viết</span>--}}
